...
class ApiContractTest {
    ...
    fun `call paths match the server contract`() {
        ...
        assertThat(PurrCallApi::class.java.postPath("createScreenShare"))
            .isEqualTo("calls/{callId}/screen-share")
        assertThat(PurrCallApi::class.java.getPath("getScreenShare"))
            .isEqualTo("calls/{callId}/screen-share")
        assertThat(PurrCallApi::class.java.deletePath("stopScreenShare"))
            .isEqualTo("calls/{callId}/screen-share")
